class MarqueeScreen():
    ...
    def __init__(self, resources, displayTimeMs, my_text, text_start_position, text_color):
    ...
    def draw(self):
        len = self.resources.DrawText(self.resources.bigfont, self.pos, self.text_height, self.text_color, self.my_text)
        self.pos -= 1
        if (self.pos + len < 0):
